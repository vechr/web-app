<template>
  ...
  >
    ...
    >
      ...
      >
        <json-editor-vue class="editor" name="eventExpression" v-model="topicEventEdit.eventExpression" />
      </a-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    const onFinish = (values: FormState) => {
      ...
      storeTopicEvent.updateTopicEventById(topicId, dataDetails.value.id, values);
    };
