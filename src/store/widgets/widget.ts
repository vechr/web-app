...
export const useWidgetStore = defineStore('widget', {
  ...
  actions: {
    ...
    addNewGaugeChart(grid: GridStack, nodeId: string, dataChart: any) { //Sama
    ...
    addNewRadarChart(grid: GridStack, nodeId: string, dataChart: any) { //Sama
      this.generateChart(grid, nodeId, dataChart, {
        x: 12,
        y: 5,
        w: 3,
    ...
    addNewPolarAreaChart(grid: GridStack, nodeId: string, dataChart: any) { //Sama
      this.generateChart(grid, nodeId, dataChart, {
        x: 12,
        y: 5,
        w: 3,
